...
#define iic_data_in()    P0DIR |= (1<<2)
#define iic_data_r()     P02
#define iic_data_h()     P0DIR |= (1<<2)
#define iic_data_l()     P0DIR &= ~(1<<2)

#define iic_clk_out()    P03=0; P0DIR |= (1<<3)
#define iic_clk_h()      P0PU |= (1<<3)
#define iic_clk_l()      P0PU &= ~(1<<3)
*/
...
/*
#define iic_data_out()   P30 = 0;P3PU |= (1<<0)
#define iic_data_in()    P3DIR |= (1<<0)
#define iic_data_r()     P30
#define iic_data_h()     P3DIR |= (1 << 0)
#define iic_data_l()     P3DIR &= ~(1 << 0)

#define iic_clk_out()    P3DIR &= ~(1<<1);//P0PU |= (1<<3)
#define iic_clk_h()      P31 = 1
#define iic_clk_l()      P31 = 0
*/

/*
#define iic_data_out()   P3DIR &= ~(1<<0);//P0PU |= (1<<2)
#define iic_data_in()    P3DIR |= (1<<0);P3PU |= (1<<0)
#define iic_data_r()     P30
#define iic_data_h()     P30 = 1
#define iic_data_l()     P30 = 0
...
#define MEM_ACTIVE_DEV     0//29

#define MEM_FRE            1
#define MEM_CHAN		   2
#define MEM_CHANNL         3
#define MEM_FM_LEN         27//28
